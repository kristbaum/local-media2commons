"""Step 4 (report): summarise licenses, dates and metadata completeness.

Reads: ``data/step4_result.csv``. Writes: ``data/step4_report.txt`` and prints
...
from ..config import STEP4_REPORT, STEP4_RESULT
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=STEP4_REPORT)
